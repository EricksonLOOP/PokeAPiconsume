...
export default function ScreenPokemon({ openCloseTab, pokemonDetails, handleOpenClose, }:
    { openCloseTab: boolean, pokemonDetails: PokemonDetails | null, handleOpenClose: Function, }) {
        ...
        <motion.div
            ...
            <div className="relative">
                <motion.div
                    ...
                    className="bg-gradient-to-tr to-purple-600 from-purple-950 w-[700px] translate-x-[-355px] md:translate-x-[-155px] h-[500px] rotate-[20deg] shadow-[0px_-30px_15px_2px_rgba(0,_0,_0,_0.5)] absolute z-10">
                    <div className="rotate-[-20deg] translate-x-[145px]  translate-y-[-45px] ">
                        <h2 className="font-bold text-[3rem] mt-5 text-white flex items-center justify-start gap-2 ">
                            {pokemonDetails?.name.charAt(0).toUpperCase()}{pokemonDetails?.name.slice(1)}
                            <b className="font-bold text-[1rem] mt-5 text-black bg-white rounded-full p-1 translate-y-[-5px]"> Lv.{Math.floor(Math.random() * (100 - 10 + 1)) + 10}</b>
                        </h2>
                ...
                <motion.div
                    ...
                    transition={{ delay: 0.3 }}
                    className="bg-gradient-to-tr to-red-600 from-red-950 w-[700px] translate-x-[0px] h-[500px] rotate-[-20deg] shadow-[0px_-30px_15px_2px_rgba(0,_0,_0,_0.5)] ">
